...
import ChangingFormat_Declaration_Unplanne_Pannel_3 from "@/components/ChangingFormat_Declaration_Unplanned_Pannel_3";

export default {
  name: "FormatChanging_Declaration_Unplanned_Panel3",
